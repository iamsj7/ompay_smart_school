...
class Ompay extends OnlineAdmission_Controller
{
    ...
    public function index()
    {
        ...
        $total = $this->amount;
        $data['amount'] = $total;
        $this->load->view('onlineadmission/ompay/index', $data);
    }
    ...
    public function pay()
    {
        ...
        $redirect_url = base_url() . 'onlineadmission/ompay/complete'; // Set your own redirect URL
    ...
    public function complete()
    {
        ...
        if (isset($_GET['txref']) && $_GET['cancelled'] != 'true') {
            ...
            if (($chargeResponsecode == "00" || $chargeResponsecode == "0") && ($chargeAmount == $amount) && ($chargeCurrency == $currency)) {
                ...
                $gateway_response['payment_mode'] = 'ompay';
                $gateway_response['payment_type'] = 'online';
                $gateway_response['note'] = $this->lang->line('online_fees_deposit_through_ompay_txn_id') . $transactionid;
