            ...
            <div class="col-md-10">
                <div class="nav-tabs-custom box box-primary theme-shadow">
                    ...
                    <ul class="nav nav-tabs nav-tabs2">
                        ...
                        <li><a href="#tab_11_1" data-toggle="tab"><?php echo $this->lang->line('ompay'); ?> </a></li>
                    ...
                    <div class="tab-content pb0">
                        ...
                        <div class="tab-pane " id="tab_11_1">
                            <form role="form" id="ompay" action="<?php echo site_url('admin/paymentsettings/ompay') ?>" class="form-horizontal" method="post">
                                <div class="box-body">
                                    <div class="row">
                                            <div class="col-md-7">
                                                <?php
                                                $ompay_result = check_in_array('ompay', $paymentlist);
                                                ?>
                                                <div class="form-group">
                                                    <label class="control-label col-md-5 col-sm-12 col-xs-12" for="exampleInputEmail1">
                                                       <?php echo $this->lang->line('public_key'); ?>
                                                    <small class="req"> *</small></label>
                                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                                        <input  name="public_key" placeholder="" type="text" class="form-control col-md-7 col-xs-12"  value="<?php echo isset($ompay_result->api_publishable_key) ? $ompay_result->api_publishable_key : ""; ?>" />
                                                        <span class=" text text-danger public_key_error"></span>
                                                    </div>
                                                </div>
                                                   <div class="form-group">
                                                    ...
                                                    <small class="req"> *</small></label>
                                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                                        <input  name="secret_key" placeholder="" type="text" class="form-control col-md-7 col-xs-12"  value="<?php echo isset($ompay_result->api_secret_key) ? $ompay_result->api_secret_key : ""; ?>" />
                                                        <span class=" text text-danger secret_key_error"></span>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <small class="req"> *</small></label>
                                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                                        <input  name="merchant_key" placeholder="" type="text" class="form-control col-md-7 col-xs-12"  value="<?php echo isset($ompay_result->api_merchant_key) ? $ompay_result->api_merchant_key : ""; ?>" />
                                                        <span class=" text text-danger merchant_key_error"></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-5 text text-center disblock">
                                                <a href="https://ompay.com/" target="_blank">
                                                    <h5><?php echo $this->lang->line('multinational_payment_gateway'); ?></h5>
                                                    <img src="https://docs.ompay.com/logo.png" width="200"><p>https://ompay.com/</p></a>
                                            </div>
                                    </div>
                                </div>
                                <!-- /.box-body -->
                    ...
                    <form role="form" action="<?php echo site_url('admin/paymentsettings/setting') ?>" id="payment_gateway" method="POST">
                        <div class="box-body minheight199">
                            <div class="form-group"> <!-- Radio group !-->
                                ...
                                <div class="radio">
                                    <label>
                                        <input type="radio"  name="payment_setting" value="ompay" <?php
                                        if ($radio_check == 'ompay') {
                                            echo "checked";
                                        }
                                        ?>>
                                        <?php echo $this->lang->line('ompay'); ?>
                                    </label>
                                </div>
                                <div class="radio">
                                    <label>
